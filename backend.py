...
class TransactionObject():
    # Definição das propriedades do objeto de transação
    database = "clientes.db"
    conn = None
    cur = None
    connected = False
    
    # Métodos para conectar, desconectar, executar consultas e persistir dados
    def connect(self):
...
# Inicialização do banco de dados e métodos para operações CRUD
def initDB():
